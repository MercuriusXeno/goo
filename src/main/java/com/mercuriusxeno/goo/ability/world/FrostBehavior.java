...
/**
 * Frost goo: the blob impact places a chain marker, and the frost
 * conversion table freezes one block at a time for the
 * {@code freeze} block effect the frost programs run. The marker's
