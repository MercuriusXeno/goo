...
/**
 * The exorite shovel: it keeps the netherite shovel's right-click use until 0
 * durability, where it stays whole and works as a bare hand (decision
 * zero-durability-stops-working).
 */
public class ExoriteShovelItem extends ShovelItem implements ExoriteGear {
     ...
     */
    public ExoriteShovelItem(ToolMaterial material, float attackDamageBaseline, float attackSpeedBaseline, Item.Properties properties) {
