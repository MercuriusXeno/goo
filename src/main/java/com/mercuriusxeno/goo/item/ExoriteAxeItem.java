...
/**
 * The exorite axe: it keeps the netherite axe's right-click use until 0
 * durability, where it stays whole and works as a bare hand (decision
 * zero-durability-stops-working).
 */
public class ExoriteAxeItem extends AxeItem implements ExoriteGear {
     ...
     */
    public ExoriteAxeItem(ToolMaterial material, float attackDamageBaseline, float attackSpeedBaseline, Item.Properties properties) {
